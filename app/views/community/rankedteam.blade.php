...
<div class="row block">
	...
	<div class="title-wrapper">
	    <h3 class="widget-title">UC TEAM BLACK</h3>
	    <div class="clear"></div>
	    <div id="template-wrapper-88" class="template-wrapper" style="margin-top:20px;">
	    <div id="block-1" class="block block-column_block span12 cf"><div id="block-2" class="block block-team_member_block span4 first cf"><div class="member"><div class="member-social"><a data-original-title="Facebook" data-toggle="tooltip" href="#" class="icon-facebook-sign"></a><a data-original-title="Twitter" data-toggle="tooltip" href="#" class="icon-twitter-sign"></a> <a data-original-title="Youtube" data-toggle="tooltip" href="#" class="icon-youtube"></a></div>
